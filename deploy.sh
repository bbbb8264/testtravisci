...
sudo scp -o StrictHostKeyChecking=no -r -i $private_key ./db.sql ubuntu@$public_ip:/var/www/html
runcmd 'sudo echo "<?php" >> /var/www/html/mysql_config.php'
runcmd 'sudo echo "    \$servername = \"localhost\";" >> /var/www/html/mysql_config.php'
...
runcmd 'sudo mysql -uroot < /var/www/html/db.sql'
